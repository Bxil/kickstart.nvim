...
require('lazy').setup({
  'tpope/vim-sleuth',
  {
    ...
    config = function()
      ...
      dap.configurations.cpp = {
        {
          ...
          program = function()
            vim.notify 'Building...'
            vim.api.nvim_command '!cmake -B build -DCMAKE_BUILD_TYPE=Debug -DCMAKE_EXPORT_COMPILE_COMMANDS=1'
            vim.api.nvim_command '!cmake --build build -j$(nproc)'
      ...
      vim.keymap.set('n', '<F7>', dap.continue, { desc = 'continue' })
    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gra', vim.lsp.buf.code_action, 'action', { 'n', 'x' })
          map('grr', vim.lsp.buf.references, 'references')
          map('gri', vim.lsp.buf.implementation, 'implementation')
          map('grd', vim.lsp.buf.definition, 'definition')
          map('grD', vim.lsp.buf.declaration, 'declaration')
          map('grt', vim.lsp.buf.type_definition, 'definition type')
          map('gO', vim.lsp.buf.document_symbol, 'symbols document')
          map('gW', vim.lsp.buf.workspace_symbol, 'symbols workspace')
